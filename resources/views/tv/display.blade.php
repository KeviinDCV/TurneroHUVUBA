        ...
        function renderTurnos(turnosList) {
            ...
            for (let i = 0; i < turnosLimitados.length; i++) {
                ...
                const estadoBadge = esAtendido ?
                    '<div style="position: absolute; top: -24px; right: 8px; z-index: 10;"><span class="bg-green-500 text-white px-2 py-1 rounded-full text-xs font-bold">✓ ATENDIDO</span></div>' :
                    '';
